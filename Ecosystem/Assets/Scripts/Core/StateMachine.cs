...
namespace Core
{
  ...
  {
    private readonly IList<IState<T, TEnum>> _states;

    public StateMachine(IList<IState<T, TEnum>> stateList)
    {
    ...
    public IState<T, TEnum> GetCorrelatingState(TEnum stateEnum)
    {
